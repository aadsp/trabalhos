...
\begin{figure*}[h]
\centering % para centralizarmos a figura
\includegraphics[width=1\textwidth]{DER_colaborador.jpg} % leia abaixo
\caption{Diagrama de Entidade e Relacionamento - Schema Colaborador}
\end{figure*}

\begin{figure*}[h]
\centering % para centralizarmos a figura
\includegraphics[width=1\textwidth]{DER_acesso.jpg} % leia abaixo
\caption{Diagrama de Entidade e Relacionamento - Schema Acesso}
\end{figure*} 

\begin{figure*}[h]
\centering % para centralizarmos a figura
\includegraphics[width=1\textwidth]{DER_tap.jpg} % leia abaixo
