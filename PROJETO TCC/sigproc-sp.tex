...
\begin{enumerate}
\item  Neste trabalho, serão consideradas abordagens ágeis aquelas que estiverem de acordo com o manifesto ágil de software. Essa classificação será dada independentemente da classificação originalmente atribuida pelos autores de cada abordagem;
...
\section{Projeto de Tela do T-AADSP}
...
\subsection{Solicitar nova senha}
\begin{figure}[h]
\centering % para centralizarmos a figura
